...
//		String outputDir = "C://Users/VULCAN/Desktop/new";
		...
		//多表
		//String[] tableNames = new String[]{"chapter","chapter1"};
		// 数据库地址
		...
		// 父包路径
		String parentPackage = "con.henry";
		// 需要去掉的表名前缀
...
//			generate(outputDir, tableName, url, userName, password, parentPackage, prefixTable);
//		}
	}
